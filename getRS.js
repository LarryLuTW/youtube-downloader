...
var getRSFromYoutubeUrl = function(url){
    var r = (new Date).getTime();
    var a = '/a/pushItem/?item=' + url + '&el=ma&bf=false&r=' + r;
    var s = escape(sig(a));
...
var getRSFromID = function(id){
    var r = (new Date).getTime();
    var a = '/a/itemInfo/?video_id=' + id + '&ac=www&t=grp&r=' + r;
    var s = escape(sig(a));
...
var getSFromDownloadUrl = function(url){
    return escape(sig(url));
}

module.exports.getRSFromYoutubeUrl = getRSFromYoutubeUrl;
module.exports.getRSFromID = getRSFromID;
module.exports.getSFromDownloadUrl = getSFromDownloadUrl;
